...
<div class="container">
  ...
  <hr/>
  <p>
  	<b>용도 : 사용자가 '값/변수/수식/객체'을 전송후에 저장해서 처리할 용도로 사용</b><br/>
  	<b>표기법 : $ {값/변수/수식/객체/제어문}</b>
  </p>
  <hr/>
<%
	String atom =  "Seoul";		// 실제업무에서는 앞의 폼태그를 통해서 넘어온 값들을 변수로 저장받는다고 가정(String atom = request.getParameter("atom");)
	String name = "홍길동";
	int su1 = 100, su2 = 200;
	// 앞의 데이터가 컨트롤러에서(서비스)객체에서 저장소를 통해서 넘겨주었을 경우에는 EL을 통해서 바로 받을수 있다.
...
%>
	...
	su1 = ${param.su1}<br/>
	su2 = ${param.su2}<br/>
	<h4>jsp에서 폼태그(get/post)로 넘긴 자료를 서블릿을 통해서 받을때</h4>
	atom = ${vo.atom}<br/>
	name = ${vo.name}<br/>
	su1 = ${vo.su1}<br/>
	su2 = ${vo.su2}<br/>
